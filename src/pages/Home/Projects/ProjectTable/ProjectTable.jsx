...
function ProjectTableRow({
  ...
  const statusClass = project.status?.toLowerCase().replace(/\s+/g, "-") || "em-analise";
  
  return (
    <tr
      className={`status-${statusClass} ${isSelected ? "selected-row" : ""}`}
    >
      ...
      <td data-label="Ações" className="actions-cell">
        ...
        <div className="action-row">
          ...
          <button
            ...
            disabled={["Arquivado", "Concluído"].includes(
              project.status,
            )}
          type="button"
